...
public class Assign2 {
	...
	static void modifyUser()
	{
		try
		{
			...
			oBrowser.findElement(objectmap.getLocator("fname")).clear();
			oBrowser.findElement(objectmap.getLocator("fname")).sendKeys("sandeep");
			oBrowser.findElement(objectmap.getLocator("lname")).clear();
			oBrowser.findElement(objectmap.getLocator("lname")).sendKeys("san");
			
			oBrowser.findElement(objectmap.getLocator("password")).clear();
			oBrowser.findElement(objectmap.getLocator("password")).sendKeys("1234");
			
			oBrowser.findElement(objectmap.getLocator("passwordcopy")).clear();
			oBrowser.findElement(objectmap.getLocator("passwordcopy")).sendKeys("1234");
			oBrowser.findElement(objectmap.getLocator("commitbtn")).click();
			Thread.sleep(3000); 
