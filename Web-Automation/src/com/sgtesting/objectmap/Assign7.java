...
public class Assign7 {
	...
	static void createTasks()
	{
		...
		try
		{
			...
			oBrowser.findElement(objectmap.getLocator("task1")).sendKeys("TASK1");
			Thread.sleep(3000);
			oBrowser.findElement(objectmap.getLocator("savetask")).click();
	...
	static void deleteTasks()
	{
		...
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("action3")).click();
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("deletetask")).click();
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("confirmdeletetask")).click();
			Thread.sleep(2000);		
