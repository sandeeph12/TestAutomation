...
public class ModifyUserScenario {
	...
	static void modifyUser()
	{
		...
		try
		{
			...
			oBrowser.findElement(By.id("userDataLightBox_emailField")).sendKeys("san@gmail.com");
			Thread.sleep(3000);
			oBrowser.findElement(By.id("userDataLightBox_usernameField")).clear();
			
			oBrowser.findElement(By.id("userDataLightBox_usernameField")).sendKeys("demosan");
